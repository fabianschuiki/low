...
RULE(func_unit_decl) \
	...
	VAR TKN(FUNC) TKN(IDENT) TKN(COLON) TKN(LPAREN) TKN(RPAREN) TKN(MAPTO) SUB(type) REDUCE_TAG(func_unit_decl2, 0) \
	VAR TKN(FUNC) TKN(IDENT) TKN(COLON) TKN(LPAREN) TKN(ELLIPSIS) TKN(RPAREN) TKN(MAPTO) SUB(type) REDUCE_TAG(func_unit_decl2, 1) \
	VAR TKN(FUNC) TKN(IDENT) TKN(COLON) TKN(LPAREN) SUB(parameter_list) TKN(RPAREN) TKN(MAPTO) SUB(type) REDUCE_TAG(func_unit_decl2, 2) \
	VAR TKN(FUNC) TKN(IDENT) TKN(COLON) TKN(LPAREN) SUB(parameter_list) TKN(COMMA) TKN(ELLIPSIS) TKN(RPAREN) TKN(MAPTO) SUB(type) REDUCE_TAG(func_unit_decl2, 3) \
RULE_END \
\
RULE(parameter_list) \
