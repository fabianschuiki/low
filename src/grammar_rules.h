...
RULE(func_unit_decl) \
	...
	VAR TKN(IDENT) TKN(COLON) TKN(LPAREN) TKN(RPAREN) SUB(type) REDUCE_TAG(func_unit_decl2, 0) \
	VAR TKN(IDENT) TKN(COLON) TKN(LPAREN) TKN(ELLIPSIS) TKN(RPAREN) SUB(type) REDUCE_TAG(func_unit_decl2, 1) \
	VAR TKN(IDENT) TKN(COLON) TKN(LPAREN) SUB(parameter_list) TKN(RPAREN) SUB(type) REDUCE_TAG(func_unit_decl2, 2) \
	VAR TKN(IDENT) TKN(COLON) TKN(LPAREN) SUB(parameter_list) TKN(COMMA) TKN(ELLIPSIS) TKN(RPAREN) SUB(type) REDUCE_TAG(func_unit_decl2, 3) \
RULE_END \
\
RULE(parameter_list) \
...
\
RULE(type_unit) \
	VAR TKN(IDENT) TKN(COLON) SUB(type) TKN(SEMICOLON) REDUCE(type_unit) \
RULE_END \
\
RULE(unit_list) \
